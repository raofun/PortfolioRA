...
const experiences = [
	{
		...
		endDate: "August 2021",
		company: "Freelance",
		position: "Dropshipping Manager",
		type: "Remote",
		location: "Texas, USA",
		description:
			"Managed and optimized dropshipping operations, including product sourcing, order fulfillment, and customer service.",
		skills: ["Dropshipping", "Data Entry", "Order Management", "Client Handling"],
	},
	{
		id: 2,
		startDate: "July 2021",
		...
		description:
			"Work for them as a lead generator and data entry expert.",
		skills: ["Airtable", "Google Sheet", "Data Entry", "Web Scraping", "Teamwork", "LinkedIn Sales Navigator"],
	},
	{
		id: 3,
		startDate: "August 2021",
		endDate: "October 2021",
		company: "The Fit Collective Chino Hills",
		position: "Social Media Manager",
		type: "Freelance",
		location: " Chino Hills, CA, USA",
		description:
			"Managed social media accounts, created content calendars, and hosted a campaign.",
	...
	},
	{
		...
		startDate: "Apr 2023",
		endDate: "July 2024",
		company: "Rising Star IT",
		position: "Virtual Assistant",
		type: "Freelance",
		location: "Dhaka, Bangladesh",
		description:
			"Assisted in daily freelancing tasks. Maintained team and helped with the Data Entry works.",
		skills: ["Virtual Assistant", "Data Entry", "Teamwork", "MS Office", "Web Research"],
	},
			...
			<div
				...
				<div className="flex flex-wrap gap-2">
					{experience.skills.map((skill, idx) => {
						const colors = ["bg-blue-600", "bg-green-600", "bg-red-600", "bg-yellow-600", "bg-purple-600"];
						const colorClass = colors[idx % colors.length];
						return (
							<span
								key={idx}
								className={`${colorClass} text-white px-3 py-1 rounded-full text-sm font-medium shadow-md transition-all duration-300 hover:scale-105`}>
								{skill}
							</span>
						);
					})}
