...
function Wrapper({ children }) {
	return (
		<div className="mx-auto container gap-10 p-10 grid grid-cols-1 my-10 max-w-full">
			<motion.div
				...
				<div className="grid grid-cols-1 gap-8">
					...
					<motion.div
						...
						<div>
							...
							<div className="gap-4 mb-4 flex items-stretch md:h-[90px] xl:h-[540px]">
							...
							<div className="flex items-center gap-2">
								<p className="text-gray-600 text-justify title text-lg">
									...
									. Driven by continuous learning, development,
									and teamwork—I look forward to evolving and 
